...
## Project Structure
    ...
    ├── testapiautocatalog_124895  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_124895`
...
2. Clone this repo and `cd testapiautocatalog_124895`
